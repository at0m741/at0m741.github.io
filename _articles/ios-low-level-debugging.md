...
​                           ![iBoot UART output](/assets/img/articles/ios-low-level-debugging/iboot.png)
...
![SWD](/assets/img/articles/ios-low-level-debugging/SWD.png)
...
![tristar](/assets/img/articles/ios-low-level-debugging/tristar.png)
...
![lightning_port_pinout](/assets/img/articles/ios-low-level-debugging/lightning_port_pinout.jpg)
...
En effet sur les appareils Apple iOS, le SWD n’est accessible que via le port lightning, mais il ne suffit pas d’un simple programme pour y accéder, il faut un câble spécial ou la grosse différence se situe dans le chip du lightning (un 1-Wire propriétaire), qui fonctionne par un échange d’identifiants (SDQ) entre le Tristar (ou Hydra pour les plus récents) et le HiFive (connecteur lightning mâle qui contient le Chip SDQ SN2025/BQ2025).
 ...
 ![twitter_EatPnX2WAAE38L2](/assets/img/articles/ios-low-level-debugging/twitter_EatPnX2WAAE38L2.jpg)
...
![lightning_connector_pinout](/assets/img/articles/ios-low-level-debugging/lightning_connector_pinout.jpg) 
...
![checkm8](/assets/img/articles/ios-low-level-debugging/checkm8.png)
...
![Astris](/assets/img/articles/ios-low-level-debugging/Astris.png)
